...
import type { Testimonial, ThemeConfig } from "@/lib/types";
...
export default function TestimonialsSection({
  ...
  const eyebrow = theme?.testimonials_eyebrow ?? "Témoignages";
  const title = theme?.testimonials_title ?? "Ce qu’ils disent";
